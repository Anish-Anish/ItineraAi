...
const mockHotels: Hotel[] = [
  {
    ...
    description:
      "Luxury hotel with world-class amenities and exceptional service",
    reviews: 2847,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      "Heritage luxury hotel with beautiful gardens and colonial charm",
    reviews: 3156,
  },
];
...
const HotelBooking = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await fetch(`${protocol}//${host}:8089/api/hotels`, {
        method: "POST",
        headers: {
